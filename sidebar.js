...
(function () {
  ...
  var CATEGORIES = [
    { label: "이미지 · PDF", key: "image", tools: [
      ...
      { slug: "image-upscale",    name: "이미지 업스케일·확대", icon: "image-up" },
      ...
      { slug: "image-invert",     name: "이미지 색 반전",       icon: "invert" },
      { slug: "watermark",        name: "이미지 워터마크",      icon: "stamp" },
      { slug: "image-blur",       name: "이미지 모자이크·블러", icon: "eye-off" },
      { slug: "bg-remover",       name: "이미지 배경 제거(누끼)", icon: "eraser" },
      ...
      { slug: "youtube-thumbnail", name: "유튜브 썸네일 다운로드", icon: "youtube" },
      { slug: "heic-to-jpg",      name: "HEIC → JPG 변환",      icon: "image-down" },
      { slug: "svg-to-png",       name: "SVG → PNG 변환",       icon: "image-plus" },
      ...
      { slug: "video-to-gif",     name: "동영상 → GIF 변환",    icon: "clapperboard" },
      ...
      { slug: "pdf-page-numbers", name: "PDF 페이지 번호 넣기", icon: "file-digit" },
    ...
    { label: "텍스트 · 생성", key: "text", tools: [
      ...
      { slug: "instagram-linebreak", name: "인스타 줄바꿈",     icon: "instagram" },
      ...
      { slug: "morse-code",         name: "모스부호 변환기",    icon: "radio" },
    ...
    { label: "생활 · 편의", key: "life", tools: [
      ...
      { slug: "quadratic-equation", name: "이차방정식 계산기", icon: "radical" },
      ...
      { slug: "roman-numerals",  name: "로마 숫자 변환기",  icon: "scroll" },
      ...
      { slug: "sleep-calculator", name: "수면 시간 계산기", icon: "bed" },
      { slug: "blood-alcohol",   name: "혈중알코올농도 계산기", icon: "beer" },
      ...
      { slug: "body-fat",        name: "체지방률 계산기",   icon: "percent" },
      { slug: "one-rep-max",     name: "1RM 최대중량 계산기", icon: "weight" },
      { slug: "child-height",    name: "자녀 키 예측 계산기", icon: "baby" },
    ...
    { label: "금융", key: "finance", tools: [
      ...
      { slug: "dsr-calculator",  name: "DSR·DTI 계산기",     icon: "scale" },
      { slug: "jeonse-conversion", name: "전월세 전환 계산기", icon: "repeat" },
      { slug: "housing-subscription", name: "주택청약 가점 계산기", icon: "house" },
      { slug: "compound-interest", name: "복리 계산기",      icon: "trending-up" },
      { slug: "stock-average",   name: "물타기(평단가) 계산기", icon: "trending-down" },
      { slug: "stock-profit",    name: "주식 수익률·손익 계산기", icon: "candlestick-chart" },
      { slug: "dividend-calculator", name: "배당금 계산기",  icon: "coins" },
      ...
      { slug: "inheritance-tax", name: "상속세 계산기",      icon: "scroll-text" },
      { slug: "comprehensive-income-tax", name: "종합소득세 계산기", icon: "receipt-text" },
      { slug: "capital-gains-tax", name: "양도소득세 계산기", icon: "building" },
    ...
    { label: "직장인 · 생산성", key: "work", tools: [
      ...
      { slug: "email-signature", name: "이메일 서명 생성기", icon: "mail" },
    ...
    { label: "색상 · 디자인", key: "color", tools: [
      ...
      { slug: "font-preview",     name: "글꼴 미리보기",     icon: "baseline" },
      ...
      { slug: "clip-path-generator", name: "clip-path 생성기", icon: "pentagon" },
    ...
    { label: "개발자 도구", key: "dev", tools: [
      ...
      { slug: "luhn-validator",   name: "신용카드 번호 검증", icon: "credit-card" },
      { slug: "base-converter",   name: "진법 변환",       icon: "binary" },
      { slug: "subnet-calculator", name: "서브넷 계산기",  icon: "network" },
      { slug: "chmod-calculator", name: "chmod 권한 계산기", icon: "lock" },
    ...
    { label: "재미 · 운세", key: "fun", tools: [
      ...
      { slug: "tojeong",         name: "토정비결 신년운세",  icon: "scroll" },
      ...
      { slug: "fake-tweet",      name: "가짜 트윗(X) 생성기", icon: "twitter" },
      { slug: "fake-instagram",  name: "가짜 인스타 게시물",  icon: "instagram" },
  ...
  var ICONS = {
    ...
    "file-digit": '<path d="M4 22h14a2 2 0 0 0 2-2V7.5L14.5 2H6a2 2 0 0 0-2 2v4" /> <path d="M14 2v6h6" /> <rect width="4" height="6" x="2" y="14" rx="2" /> <path d="M10 14h2v6" /> <path d="M10 20h4" />',
    ...
    "beer": '<path d="M17 11h1a3 3 0 0 1 0 6h-1" /> <path d="M9 12v6" /> <path d="M13 12v6" /> <path d="M14 7.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 0 1 0-5c.78 0 1.57.5 2.5.5S9.44 3 11 3s2 .5 3 .5 1.72-.5 2.5-.5a2.5 2.5 0 0 1 0 5c-.78 0-1.5-.5-2.5-.5Z" /> <path d="M5 8v10a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V8" />',
