...
- **즐겨찾기(★)** — 자주 쓰는 도구를 별표해 사이드바 상단·홈 바로가기에 고정 (localStorage, 가입 없음)
- **작업대([`/workbench/`](https://dogubox.shop/workbench/))** — 도구 2~3개를 한 화면 분할 패널에서 동시에 사용. 구성은 URL로 공유 가능 *(도구가 아닌 별도 페이지)*
